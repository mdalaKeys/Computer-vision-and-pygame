...
#closedHand_sound = mixer.Sound('')
#catching_sound = mixer.Sound('')
...
pygame.display.set_caption("Eat with your hands")

icon = pygame.image.load('images/others/apple.png').convert_alpha()
resized_icon = pygame.transform.scale(icon, desired_size)
pygame.display.set_icon(resized_icon)

backgroundImg = pygame.image.load('images/others/pic.jpg').convert()
...
x = width/2 - 64
y = height/2 - 64
openHandImg = pygame.image.load('images/others/openHand.png').convert_alpha()
openHandImg = pygame.transform.scale(openHandImg, (128, 128))
openHand_rect = openHandImg.get_rect(topleft=(x, y))

closedHandImg = pygame.image.load('images/others/closedHand.png').convert_alpha()
...
for i in range(numberOfInsects):
    ...
    InsectImg.append(pygame.image.load('images/others/apple.png').convert_alpha())
